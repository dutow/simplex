...
namespace simplex {
	...
	protected:
		window(application& owner_application, std::wstring title, unsigned int width, unsigned int height) : owner_application(owner_application), title(title), width(width), height(height)  {};
